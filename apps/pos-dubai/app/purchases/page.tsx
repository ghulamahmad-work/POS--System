  ...
  return (
    <AppFrame
      ...
      headerActions={
        <Link
          href="/purchases/new"
          className="inline-flex h-10 items-center rounded-md bg-[var(--brand-600)]/80 px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-[var(--brand-700)]/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-500)]"
        >
          New Order
        </Link>
      }
